 ...
 * [FragmentListUsers.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FragmentListUsers.newInstance] factory method to
...
class FragmentListUsers : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentListUsers.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                FragmentListUsers().apply {
